        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary shadow border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" action="resetpass.htm" method="post">
                <div class="form-group mb-3">
                  ...
                  <small id="emailHelp" class="form-text text-muted error-mes">${val_email}</small>
                </div>
                
                <div class="text-center">
                	<span class="text-muted error-mes">${check_mess}</span>
