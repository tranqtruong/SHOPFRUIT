        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0" style="display: flex; flex-direction: row; justify-content: space-between;">
              <h3 class="mb-0">Product tables: ${message_search}</h3>
              <a href="products/insert.htm" class="btn btn-sm btn-neutral"	>New Product+</a>
            </div>
            <div class="table">
	                ...
	                <tr>
	                    <th scope="row">
	                      <div class="media align-items-center">
	                        <a href="#" class="avatar rounded-circle mr-3">
	                          <img alt="Image placeholder" src="./images/${p.productImage}">
	                        </a>
	                        <div class="media-body">
	                          <span class="mb-0 text-sm">${p.productName}</span>
	                        </div>
	                      </div>
	                    </th>
	                    <td>
	                    ...
	                    <td>
	                      <span class="badge badge-dot">
		                        <i class="${p.active?'bg-success':'bg-danger'}"></i> ${p.active?'active':'inactive'}
		                  </span>
	                    </td>
	                    <td>
	                      ${p.quantity} Kg
	                    ...
	                    <td>
	                      <div class="d-flex align-items-center">
	                        <span class="mr-2">
	                        	<fmt:formatNumber value="${p.discount/100}" type="percent"/>
	                        	
	                        </span>
	                        <div>
	                          <div class="progress">
	                            <div class="progress-bar bg-info" role="progressbar" aria-valuenow="${p.discount}" aria-valuemin="0" aria-valuemax="100" style="width: ${p.discount}%;"></div>
	                          </div>
	                        </div>
	                      </div>
	                    </td>
	                    <td class="text-right">
	                      <div class="dropdown">
	                        ...
	                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
	                          <a class="dropdown-item" href="products/detail/${p.productId}.htm">Detail</a>
	                          <a class="dropdown-item" href="products/update/${p.productId}.htm">Edit</a>
	                          <a class="dropdown-item" onclick="theFunction(h = 'products/delete/${p.productId}.htm');">Delete</a>
