      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="shop/home.htm">Home</a></span> <span>Checkout</span></p>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-7 ftco-animate">
		  	<form:form action="./shop/order.htm" class="billing-form" method="post" modelAttribute="order">
	                ...
	                <div class="w-100"></div>
			            <div class="col-md-12">
			            	<div class="form-group">
			            		...
			            		<form:textarea path="note" id=""  rows="7" class="form-control" placeholder="Message"/>
			            		<div class="meta error-mes"><form:errors path="Note"/></div>
			            	</div>
			            </div>
			            <button id="mybtn3" type="submit" hidden="true"></button>
	          		...
	          		<div class="cart-detail p-3 p-md-4">
	          			<h3 class="billing-heading mb-4">Payment Method</h3>
									<div class="form-group">
										<div class="col-md-12">
											<div class="radio">
											   <label><input checked="checked" type="radio" name="optradio" class="mr-2"> Cash On Delivery</label>
											</div>
										</div>
									</div>
									...
									<p><a href="javascript:{}" onclick="document.getElementById('mybtn3').click();" class="btn btn-primary py-3 px-4">Place an order</a></p>
								</div>
	          	</div>
	          </div>
          </div> <!-- .col-md-8 -->
