  ...
  <body class="goto-here">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="shop/home.htm">Home</a></span> <span>My Order</span></p>
    ...
    <section class="ftco-section ftco-cart">
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-8 sidebar ftco-animate"> <h2 style="font-size: 22px;" class="mb-0">Order List</h2> </div>
			              ...
			              <div class="form-group">
			            	...
			            	<div class="select-wrap">
			                  ...
			                  <select name="" id="" class="form-control" onchange="window.location.href=this.value">
			                  	<option ${select0} value="./shop/myorder.htm?status=0">Chờ xác nhận </option>
			                    <option ${select3} value="./shop/myorder.htm?status=3">Chờ Lấy Hàng</option>
			                    <option ${select4} value="./shop/myorder.htm?status=4">Đang giao</option>
			                    <option ${select5} value="./shop/myorder.htm?status=5">Đã giao</option>
			                    <option ${select2} value="./shop/myorder.htm?status=2">Đã huỷ</option>
			                  </select>
			                </div>
			            </div>
			        </div>
	    				...
	    				<table class="table">
						    ...
						    <tbody>
						    	<c:forEach var="o" items="${orders}"> 
						    		<tr class="text-center">
								       <td><a href="./shop/orderdetail/${o.id}.htm">${o.id}</a></td>
								        
								       <td class="product-name">
								        	<h3>${o.fullName}</h3>
								        	<p>
								        		<c:set var="string" value="${o.address}"/>  
								        ...
								        <td class="product-remove">
								        	<c:choose>
												<c:when test="${o.status==0||o.status==3}"><a href="./shop/cancelorder/${o.id}.htm"><span>Yêu Cầu Huỷ</span></a></c:when>
												<c:when test="${o.status==10||o.status==13}"><p>Đã gửi yêu cầu huỷ</p><a href="./shop/continueorder/${o.id}.htm"><span>Tiếp Tục Mua</span></a></c:when>
